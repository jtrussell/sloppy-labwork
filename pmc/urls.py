...
urlpatterns = [
    ...
    path('@me/awards/pin/', views.pin_award, name='pmc-pin-award'),
    path('@me/awards/unpin/<int:pk>/', views.unpin_award, name='pmc-unpin-award'),
    path('@me/awards/reorder-pins/', views.reorder_pinned_awards,
         name='pmc-reorder-pins'),
