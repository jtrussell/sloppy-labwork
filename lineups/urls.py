...
urlpatterns = [
    ...
    path('<str:lineup_code>/notes/add/', views.lineup_note_add, name='lineups-note-add'),
    path('<str:lineup_code>/notes/<int:note_id>/edit/', views.lineup_note_edit, name='lineups-note-edit'),
