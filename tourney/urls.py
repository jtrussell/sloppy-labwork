...
urlpatterns = [
    ...
    path('<int:tournament_id>/stage/prepare/', views.prepare_stage_seeding, name='tourney-prepare-stage-seeding'),
    path('<int:tournament_id>/stage/prepare-current/', views.prepare_current_stage_seeding, name='tourney-prepare-current-stage-seeding'),
    path('<int:tournament_id>/stage/confirm/', views.confirm_seeding, name='tourney-confirm-seeding'),
    path('<int:tournament_id>/stage/update-order/', views.update_seeding_order, name='tourney-update-seeding-order'),
    path('<int:tournament_id>/stage/randomize/', views.randomize_seeding, name='tourney-randomize-seeding'),
    ...
    path('<int:tournament_id>/player/match/add-result/', views.player_add_match_result, name='tourney-player-add-match-result'),
]