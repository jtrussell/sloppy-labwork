...
function resetMatch() {
    ...
    resetBtn.setAttribute('hx-confirm', `Are you sure you want to reset this match between ${playerNames}?`);
...
function openAddMatchModal() {
    ...
    playerTwoSelect.innerHTML = '<option value="">Select Player Two (Bye)</option>';
...
document.addEventListener('click', function(e) {
    ...
    const playerMatchReportModal = document.getElementById('playerMatchReportModal');
